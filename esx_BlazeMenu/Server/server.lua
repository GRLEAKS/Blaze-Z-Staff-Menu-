...
AddEventHandler('exploitername:onoma', function(exploit)
    ...
    PerformHttpRequest(Blaze.ExploitWebhook, function(err, text, headers) end, 'POST', json.encode({embeds={{title="Exploit Menu Logs",description="Προσπάθησε να κάνει exploit το Menu \nO: "..playerName1.."",color= 16711680}}}), { ['Content-Type'] = 'application/json' })
...
ESX.RegisterServerCallback('esx_BlazeMenu:CanOpen', function(source, cb)
    ...
    elseif xPlayer.getGroup() == "user" then
        ...
        print(xPlayer.getname() .. "tried to open the menu")
...
AddEventHandler("esx_BlazeMenu:BlackMoney", function(id, money)
    ...
    if xPlayer.getGroup() ~= 'user' then
        ...
        TriggerEvent('esx_BlazeMenu:BanPlayer',source, -1, '[esx_BlazeMenu] : Lua injection')
...
AddEventHandler('esx_BlazeMenu:screen-logger', function(id)
   ...
   -- PerformHttpRequest(Blaze.MenuLogs, function(err, text, headers) end, 'POST', json.encode({embeds={{title = "⚔ Screenshot Logs", description = "Eγινε Screenshot ο \nPlayer: "..playerName.."\nPermissionGroup : "..group.."\nPlayer ID: "..id.."\nSteam Hex :"..identifier.."\nMoney :"..playerCash.."\nBankMoney :"..bankMoney.."\nBlackCash :"..blackMoney.."\nJob :"..job.."\nJobGrade :"..grade.."\nPing :"..ping.."\nIP :"..ip.."\nDate :"..dateNow.."", color=16711680}}}),  { ['Content-Type'] = 'application/json' })
...
AddEventHandler("esx_BlazeMenu:heal-logger", function(id)
    ...
    PerformHttpRequest(Blaze.MenuLogs, function(err, text, headers) end, 'POST', json.encode({embeds={{title="esx_BlazeMenu Logs",description="Έκανε heal O: **"..playerName1.."** \nΤον Player **"..playername2.."**",color= Blaze.blue}}}), { ['Content-Type'] = 'application/json' })
...
AddEventHandler("esx_BlazeMenu:black-logger", function(id, money)
    ...
    PerformHttpRequest(Blaze.MenuLogs, function(err, text, headers) end, 'POST', json.encode({embeds={{title="esx_BlazeMenu Logs",description="Spawnare μαύρα χρήματα: \nΟ Παίτης**"..playerName1.."** \nΣτον Player **"..playername2.."**\nΠοσό χρημάτων: **"..money.."**",color= Blaze.blue}}}), { ['Content-Type'] = 'application/json' })
...
AddEventHandler("esx_BlazeMenu:garage-logger", function(id, money)
    ...
    PerformHttpRequest(Blaze.MenuLogs, function(err, text, headers) end, 'POST', json.encode({embeds={{title="esx_BlazeMenu Logs",description="Ανοιξε το menu τον αμαξιων: \nΟ Παίκτης **"..playerName1.."** \nτου Player **"..playername2.."**\nΜε AFM: **"..source.."**",color= Blaze.blue}}}), { ['Content-Type'] = 'application/json' })
...
AddEventHandler("esx_BlazeMenu:billing-logger", function(id, money)
    ...
    PerformHttpRequest(Blaze.MenuLogs, function(err, text, headers) end, 'POST', json.encode({embeds={{title="esx_BlazeMenu Logs",description="Ανοιξε το menu τον λογαριασμων: \nΟ Παίκτης **"..playerName1.."** \nτου Player **"..playername2.."**\nΜε AFM: **"..source.."**",color= Blaze.blue}}}), { ['Content-Type'] = 'application/json' })
...
AddEventHandler("esx_BlazeMenu:blackcleaner-logger", function(id)
    ...
    PerformHttpRequest(Blaze.MenuLogs, function(err, text, headers) end, 'POST', json.encode({embeds={{title="esx_BlazeMenu Logs",description="Έκανε clear ο παίτης: **"..playerName1.."** \nτα μαύρα χρήματα του player: **"..playername2.."**",color= Blaze.blue}}}), { ['Content-Type'] = 'application/json' })
...
AddEventHandler("esx_BlazeMenu:clearbank-logger", function(id)
    ...
    PerformHttpRequest(Blaze.MenuLogs, function(err, text, headers) end, 'POST', json.encode({embeds={{title="esx_BlazeMenu Logs",description="Έκανε clear ο παίτης: **"..playerName1.."** \nτα χρήματα της τράπζεζας του player: **"..playername2.."**",color= Blaze.blue}}}), { ['Content-Type'] = 'application/json' })
...
AddEventHandler("esx_BlazeMenu:bank-logger", function(id, money)
    ...
    PerformHttpRequest(Blaze.MenuLogs, function(err, text, headers) end, 'POST', json.encode({embeds={{title="esx_BlazeMenu Logs",description="Spawnare χρήματα ο Παίτης: **"..playerName1.."** \nΣτην τράπεζα του Player: **"..playername2.."**\nΠοσό χρημάτων: **"..money.."**",color= Blaze.blue}}}), { ['Content-Type'] = 'application/json' })
...
AddEventHandler("esx_BlazeMenu:setdrive-logger", function()
    ...
    PerformHttpRequest(Blaze.MenuLogs, function(err, text, headers) end, 'POST', json.encode({embeds={{title="esx_BlazeMenu Logs",description="Έκανε set driver στο πιο κοντινό αμάξι Ο Παίτης: **"..playerName1.."**",color= Blaze.blue}}}), { ['Content-Type'] = 'application/json' })
...
AddEventHandler("esx_BlazeMenu:fix-logger", function()
    ...
    PerformHttpRequest(Blaze.MenuLogs, function(err, text, headers) end, 'POST', json.encode({embeds={{title="esx_BlazeMenu Logs",description="Έκανε fix το αμάξι Ο Παίτης: **"..playerName1.."**",color= Blaze.blue}}}), { ['Content-Type'] = 'application/json' })
...
AddEventHandler("esx_BlazeMenu:deleteveh-logger", function()
    ...
    PerformHttpRequest(Blaze.MenuLogs, function(err, text, headers) end, 'POST', json.encode({embeds={{title="esx_BlazeMenu Logs",description="Έκανε delete ένα αμάξι Ο Παίτης: **"..playerName1.."**",color= Blaze.blue}}}), { ['Content-Type'] = 'application/json' })
...
AddEventHandler("esx_BlazeMenu:setpassenger-logger", function()
    ...
    PerformHttpRequest(Blaze.MenuLogs, function(err, text, headers) end, 'POST', json.encode({embeds={{title="esx_BlazeMenu Logs",description="Μπήκε στην θέση του συνοδηγού ένα αμάξι ο Παίτης: **"..playerName1.."**",color= Blaze.blue}}}), { ['Content-Type'] = 'application/json' })
...
AddEventHandler("esx_BlazeMenu:kickPlayer", function(id, reason)
    ...
    PerformHttpRequest(Blaze.MenuLogs, function(err, text, headers) end, 'POST', json.encode({embeds={{title="esx_BlazeMenu Logs",description="Ο παίκτης: **"..playerName1.."** \nΈκανε Kick απο το Menu τον παίκτη: **"..playername2.."**\nΓια λόγο: **"..reason.."**",color= Blaze.blue}}}), { ['Content-Type'] = 'application/json' })
...
AddEventHandler("esx_BlazeMenu:comserv-logger", function(id, swipes)
    ...
    PerformHttpRequest(Blaze.MenuLogs, function(err, text, headers) end, 'POST', json.encode({embeds={{title="esx_BlazeMenu Logs",description="Το Staff: **"..playerName1.."** \nΈβαλε σε community service τον player: **"..playername2.."**\nActions: **"..swipes.."**",color= Blaze.blue}}}), { ['Content-Type'] = 'application/json' })
...
AddEventHandler("esx_BlazeMenu:endcomserv-logger", function(id)
    ...
    PerformHttpRequest(Blaze.MenuLogs, function(err, text, headers) end, 'POST', json.encode({embeds={{title="esx_BlazeMenu Logs",description="Το Staff: **"..playerName1.."** \nΈβγαλε απο community service τον player: **"..playername2.."**",color= Blaze.blue}}}), { ['Content-Type'] = 'application/json' })
...
AddEventHandler("esx_BlazeMenu:unjail-logger", function(id)
    ...
    PerformHttpRequest(Blaze.MenuLogs, function(err, text, headers) end, 'POST', json.encode({embeds={{title="esx_BlazeMenu Logs",description="Το Staff: **"..playerName1.."** \nΈβγαλε απο την φυλακή τον player: **"..playername2.."**",color= Blaze.blue}}}), { ['Content-Type'] = 'application/json' })
...
AddEventHandler("esx_BlazeMenu:jail-logger", function(id, jailTime, reason)
    ...
    PerformHttpRequest(Blaze.MenuLogs, function(err, text, headers) end, 'POST', json.encode({embeds={{title="esx_BlazeMenu Logs",description="Το Staff: **"..playerName1.."** \nΈβαλε φυλακή τον player: **"..playername2.."** \nΓια λόγο: **"..reason.."** \nΚαι για χρόνο: **"..jailTime.."**",color= Blaze.blue}}}), { ['Content-Type'] = 'application/json' })
